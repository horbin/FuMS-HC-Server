 ...
 [  // Division #1
   [         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
    ...
    // Pilots                                                          # and type  |         Patrol     |    spawn   | dest  | 'Patrol' options   
       ...
       [["RESISTANCE","COMBAT","RED","COLUMN"],   [  [3, "Driver"]  ],   ["TrackRoute",[0,0],[0,0],["COMBAT","NORMAL",["Selakano","Zaros","Panochori"],true,false,true,100   ]]]
  ],
  [   
    ...
    [["RESISTANCE","COMBAT","RED","COLUMN"],[[1,"Sniper"],[3,"Rifleman"]],["PatrolRoute",[0,0],[0,0],["COMBAT","NORMAL",["Selakano","Zaros","Panochori"],true,false,true,100   ]]]
