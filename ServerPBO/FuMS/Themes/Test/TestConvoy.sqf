...
//------------------------------------------------------------------------------------
//-----Mission Area Setup-----
    "TestConvoy",  // Mission Title NOSPACES!
    200                // encounter radius
],[ 
//------------------------------------------------------------------------------------
//-----Notification Configuration-----
//--Map Marker Config.
    "Test Convoy",  // Name, set to "" for nothing
...
// These two delays will also affect how much time will elapse from mission completion until living AI cleanup.
   ...
   // Mission spawn message, DO NOT Remove these! They can be edited down to "" if desired.
     ...
     "Defense Alert!", 
     "High Command is establishing a patrol in the West" //description/radio message.
],[  
    // Mission Success Message
    "Mission Success",  // title line
     "",
     "Notifying High Command that the patrol has been destroyed!"
],[
...
[
 ...
 [         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
   [  "B_Truck_01_transport_EPOCH",[-100,-200],[1,"Rifleman"],        "Truck01"      ], 
   [  "C_Offroad_01_EPOCH"           ,[-120,-200],[1,"Rifleman"],     "Truck01"      ], 
   [  "C_Offroad_01_EPOCH"           ,[-140,-200],[1,"Rifleman"],     "Truck01"      ]
   ...
   [["RESISTANCE","COMBAT","RED","COLUMN"],   [  [3, "Driver"]  ],   ["PatrolRoute",[-100,-200],[0,0],["AWARE","LIMITED",["Stavros","Lakka","Agios Dionysios","Alikampos","Neochori"], true, true, false]   ]]
  ],[   
    ...
    [["RESISTANCE","COMBAT","RED","COLUMN"],[[1,"Sniper"],[5,"Rifleman"]],["PatrolRoute",[-100,-200],[0,0],["COMBAT","NORMAL",["Stavros","Lakka","Agios Dionysios","Alikampos","Neochori"], true, true, false]   ]],
...
//      ["HighUnitCount", "GUER",10,40,[0,0]] // 10 enemies get within 40m's of encounter center
           ["Timer",1800]  // mission ends after 30 minutes if not completed
    ],   
