...
//------------------------------------------------------------------------------------
//-----Mission Area Setup-----
    "TestMissionEnemy",  // Mission Title NOSPACES!
    200                // encounter radius
],[ 
//------------------------------------------------------------------------------------
//-----Notification Configuration-----
//--Map Marker Config.
    "Test Mission Enemy",  // Name, set to "" for nothing
...
// These two delays will also affect how much time will elapse from mission completion until living AI cleanup.
   ...
   // Mission spawn message, DO NOT Remove these! They can be edited down to "" if desired.
     "Humans are invading",  // title line
     "Humans are in conflict with each other!", 
     "Our enemies have found us! " //description/radio message.
],[  
...
// Refer to LootData.sqf for available loot types and contents.
    "None" ,  // Loot to spawn with mission creation
...
// Example below shows how town names can be used in place of spawn locations and offsets!
    [["WEST","COMBAT","RED","LINE"],[[3,"Rifleman"]],["Buildings",[70]]], // 3 rifleman that will patrol all buildings within 70m for unlimited duration
// **End 'copy'******(see Patrol Options below for other AI behaviour)
// Example of a 3D map location. This loc is specific to ALTIS
[["WEST","COMBAT","RED","LINE"],[[5,"Rifleman"]],["BoxPatrol",[21520,11491.9,0],[0,0],[70] ]],
...
// [["WEST","COMBAT","RED","LINE"],[[2,"Hunter"]],["Sentry",[6,6],[0,0],[30]]
],
...
[
 ...
 [         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
   ...
   [["WEST","COMBAT","RED","COLUMN"],   [  [3, "Driver"]  ],   ["Convoy",[-75,-600],[0,-50],["NORMAL",true,true, true]   ]]
  ],[   
    ...
    [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[1,"Rifleman"]],["BoxPatrol",[-70,-600],[0,0],[0]]],
  //  [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[2,"Rifleman"]],["BoxPatrol",[-70,-600],[50,0],[50]]],
    [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[1,"Rifleman"]],["BoxPatrol",[-70,-600],[-50,0],[50]]]
   ...
   // otherwise troops will remain in vehicle unless it is engaged. Once vehicle destroyed, Troops will move onto their 'Patrol Logic'.
    ...
    [         // Vehicle                     Offset         Crew (only 1 type!)   Cargo
      ...
      [                 
           // Drivers                                                          # and type  |         Patrol     |    spawn   | dest       | 'Patrol' options
          [["WEST","COMBAT","RED","COLUMN"],   [  [1, "Driver"]  ],   ["BoxPatrol",[-600,-200],[-50,50],[0]   ]]
          
      ],
      // Troops : These are distributed across all vehicles in this convoy.                                                         
     [      //  Troop behaviour and side options                        # and type of Troops                               Patrol logic |  spawn     |dest |'Patrol' options
        [["WEST","COMBAT","RED","COLUMN"],   [  [1,"Sniper"],[4,"Rifleman"]  ],   ["BoxPatrol",[-600,-200],[20,0],[0]   ]]
 //     [["WEST","COMBAT","RED","COLUMN"],   [  [1,"Sniper"],[5,"Rifleman"]     ],   ["BoxPatrol",[-600,-200],[20,20],[0]   ]]
            // 'dest' for troops is where they will go to perform their 'Patrol Logic' once the disembark the convoy IF their vehicle's driver group is using the 'Convoy' patrol logic.
             // otherwise troops will remain in vehicle unless it is engaged. Once vehicle destroyed, Troops will move onto their 'Patrol Logic'.
     ]
   ] 
...
[ // NOTE: side WEST for groups == side GUER for Triggers.
    [    //WIN Triggers and Controls
  //    ["LowUnitCount", "WEST", 0, 0, [0,0]], // all enemies are dead:  side options "EAST","WEST","GUER","CIV","LOGIC","ANY"
...
//     [  "O_Heli_Light_02_unarmed_EPOCH"           ,[0,-1800],[1,"Rifleman"],     "None"      ], 
   ...
   [["WEST","COMBAT","RED","COLUMN"],   [  [1, "Driver"]  ],   ["ParaDrop",[0,-1700],[0,0],["Normal", 100, true,true  ]   ]]
  ],[   
     ...
     //  Troop behaviour and side options                    # and type of Troops     Patrol logic |  spawn     |dest |'Patrol' options
 //   [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[6,"Rifleman"]],["BoxPatrol",[-70,-1900],[0,0],[0]]],
 //   [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[6,"Rifleman"]],["BoxPatrol",[-70,-1800],[50,0],[50]]],
    [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[6,"Rifleman"]],["BoxPatrol",[0,-1700],[-50,0],[50]]]
   ...
   [         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
    ...
    // Pilots                                                          # and type  |         Patrol     |    spawn   | dest  | 'Patrol' options
   [["WEST","COMBAT","RED","COLUMN"],   [  [3, "Driver"]  ],   ["PatrolRoute",[0,-1800],[0,0],["COMBAT","NORMAL",["Pyrgos","Stavros","Telos"],true, false, false,100]   ]]
  ],[   
     // Troops : These are distributed across all aircraft in the division. These lines are identical to the lines in the group section.
     //  Troop behaviour and side options                    # and type of Troops     Patrol logic |  spawn     |dest |'Patrol' options
  //  [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[6,"Rifleman"]],["BoxPatrol",[-70,-1700],[0,0],[0]]],
   // [["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[6,"Rifleman"]],["BoxPatrol",[-70,-1750],[50,0],[50]]],
    //[["WEST","COMBAT","RED","COLUMN"],[[1,"Sniper"],[6,"Rifleman"]],["BoxPatrol",[0,-1800],[-50,0],[50]]]
   // 'dest' for troops is where they will go to perform their 'Patrol Logic' once they get on deck
     ]
   ]
