...
[
 ...
 [         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
   [  "B_Truck_01_transport_EPOCH",[0,-600],[1,"Rifleman"],        "Truck01"      ] 
    ],[  
    // Drivers                                                         # and type  |         Patrol     |    spawn   | dest  | 'Patrol' options
   [["RESISTANCE","COMBAT","RED","COLUMN"],   [  [1, "Driver"]  ],   ["Convoy",[0,-600],[0,0],["NORMAL",true,true, true, "XFILL"]   ]]
  ],[   
 ...
 [         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
   ...
   [["RESISTANCE","COMBAT","RED","COLUMN"],   [  [1, "Driver"]  ],   ["Convoy",[0,600],[0,0],["NORMAL",true,true, true,"XFILL"]   ]]
     ...
     [  // Convoy #3  East
 [         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
   [  "B_Truck_01_transport_EPOCH",[600,0],[1,"Rifleman"],        "Truck01"      ] 
    ],[  
    // Drivers                                                         # and type  |         Patrol     |    spawn   | dest  | 'Patrol' options
   [["RESISTANCE","COMBAT","RED","COLUMN"],   [  [1, "Driver"]  ],   ["Convoy",[600,0],[0,0],["NORMAL",true,true, true,"XFILL"]   ]]
  ],[   
...
[ // NOTE: side RESISTANCE for groups == side GUER for Triggers.
  ...
  //    ["LowUnitCount", "GUER", 0, 500, [0,0]], // all enemies are dead:  side options "EAST","WEST","GUER","CIV","LOGIC","ANY"
  //    ["ProxPlayer", [0,0], 20, 1] // 1 player is within 20 meters of encounter center.
//	  ["Reinforce", 100, "Reinforcements"] // %chance when requested, Mission to run
    ],
