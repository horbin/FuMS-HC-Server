...
// This routine is IDENTICAL to PatrlRoute, except for the addition of a convoy map marker
//  that tracks the 'lead vehicle's' position.
//**************************************************************
...
[_group] call FuMS_fnc_HC_AI_TrackAI;
//HCDEBUG = "WP";
_compRadius = 150;
