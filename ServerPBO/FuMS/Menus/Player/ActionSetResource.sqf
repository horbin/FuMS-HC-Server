...
diag_log format ["##ActionSetResource: Attempting to set Resource from :%1",FuMS_resourceTxt];
FuMS_MissionResource = FuMS_HCIDs select _index;
FuMS_resourceTxt = FuMS_HCNames select _index;
diag_log format ["##ActionSetResource: Attempting to set Resource to :%1",FuMS_resourceTxt];
